...
@Component({
  selector: 'app-most-frequent-buyers-report',
  templateUrl: './most-frequent-buyers-report.component.html',
  styleUrls: ['./most-frequent-buyers-report.component.scss']
})
export class MostFrequentBuyersReportComponent implements OnInit {
  dataSource = new MatTableDataSource<Reports>();
  displayedColumns: string[] = ['customerId', 'customerName', 'customerCellphoneNumber', 'customerEmailAddress', 'customerBusinessName','numberOfSalesMade'];
  tableData: any;
  Sales: any ;
...
generatePdf(): void {
  ...
  html2canvas(Data).then(canvas => {
    ...
    PDF.save('Most Frequent Buyers Report.pdf');
  });
}
