...
export class OnlineSalesService {
  ...
  CollectionSMS(OnlineSales: OnlineSales): Observable<OnlineSales[]> {
    return this.http.post<OnlineSales[]>(`${this.server}Email/CollectionSMS`, OnlineSales, this.httpOptions);
  }
