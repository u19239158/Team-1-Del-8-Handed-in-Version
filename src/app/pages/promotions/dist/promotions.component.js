...
exports.PromotionsComponent = void 0;
var core_1 = require("@angular/core");
var PromotionsComponent = /** @class */ (function () {
    function PromotionsComponent(api, cartService) {
        this.api = api;
    ...
    //outside ng oninit
    PromotionsComponent.prototype.addtocart = function (item) {
        this.cartService.addtoCart(item);
    };
    PromotionsComponent.prototype.openmodal = function (productItems) {
        document.querySelector('.modal').classList.add('is-active');
        this.cartService.showItemModal(productItems);
    };
    PromotionsComponent.prototype.closemodal = function (item) {
        this.modalItems = [];
        document.querySelector('.modal').classList.remove('is-active');
        this.cartService.closeItemModal(item);
    };
    PromotionsComponent.prototype.Itemdropdown = function () {
        document.querySelector('.dropdown').classList.add('is-active');
    };
    PromotionsComponent.prototype.ItemdropdownClose = function () {
